...
net_type = 'preact_resnet_EEG' #preact_resnet_covid
target_data = 'NIH_EEG_V2'

# defined in data load
# NIH_EEG_V1: all classes ['EGLO', 'EGSA', 'IGES', 'OGLO', 'OGSA']
# NIH_EEG_V2: all classes ['EGLO', 'IGES', 'OGLO']
# NIH_EEG_V3: all classes ['EGSA', 'IGES', 'OGSA']
...
project_path = '/home/jhpnih/0_Project/0_Covid_classification/0_covid_220327/'
...
train_data, train_labels, test_data, test_labels, num_classes = JH_utile.data_load(dataset_info, dataset_path, args)
data_max, data_min, data_mean, data_std = JH_utile.load_nor_value(dataset_info, args)
# data_mean : mean of the train dataset
# data_std : std of the train dataset

num_classes = [num_classes]
transform_train = transforms.Compose([transforms.Normalize(data_mean, data_std)])
transform_test = transforms.Compose([transforms.Normalize(data_mean, data_std)])


trainset = JH_utile.MyEEGDataSet(train_data, train_labels, data_max, data_min, transform=transform_train)
testset = JH_utile.MyEEGDataSet(test_data, test_labels, data_max, data_min, transform=transform_test)
